...
import com.whut.zhiyin.util.MyMediaController;
...
public class MusicTeachVideoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_teach_video);
        ButterKnife.bind(this);
        mURL = getIntent().getStringExtra("URL");
        int flag = WindowManager.LayoutParams.FLAG_FULLSCREEN;
        Window window = MusicTeachVideoActivity.this.getWindow();
        ...
        surfaceView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                //ToastUtils.showLong(MusicTeachVideoActivity.this, "准备好");
                surfaceView.start();
            }
        });
        surfaceView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                //ToastUtils.showLong(MusicTeachVideoActivity.this, "播放出错");
                finish();
                return false;
            }
        });
